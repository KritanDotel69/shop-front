...
const AddProduct = () => {
  ...
  const valSchema = Yup.object().shape({
    ...
    product_detail: Yup.string().min(10, 'too short').max(1000, 'max character 1000').required(),
        ...
        <Card className='place-self-center' color="transparent" shadow={false} >
          ...
          <form onSubmit={formik.handleSubmit} className="mt-5 mb-2 ">
            <div className="space-y-7 flex flex-col ">
              ...
              <div className="w-72">
                <Select label="SelectCategory" name='category' onChange={(e) => formik.setFieldValue('category', e)}>
